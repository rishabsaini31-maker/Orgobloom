  ...
  return (
    <>
      ...
      <main className="smooth-scroll min-h-screen">
        ...
        {/* Featured Products Section - Premium Classic Design */}
        <section
          id="home-content"
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-1/2 left-1/2 w-[800px] h-[800px] bg-primary-50 rounded-full blur-3xl opacity-20 -translate-x-1/2 -translate-y-1/2"></div>
          </div>

          <div className="container mx-auto px-4 relative z-10">
            {/* Premium Header with Classic Typography */}
            <div className="text-center mb-16">
              ...
              {/* Badge */}
              <span className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-50 to-emerald-50 text-primary-700 px-6 py-2 rounded-full text-sm font-semibold mb-6 border border-primary-100 shadow-sm">
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path d="M10 2L3 7v11a1 1 0 001 1h12a1 1 0 001-1V7l-7-5zm0 11a3 3 0 100-6 3 3 0 000 6z" />
                </svg>
                Handcrafted with Care
              </span>

              {/* Main Title with Classic Serif Style */}
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 tracking-tight">
                <span className="block">Premium</span>
                <span className="bg-gradient-to-r from-primary-600 via-emerald-600 to-green-600 bg-clip-text text-transparent">
                  Organic Fertilizers
                </span>
              </h2>
              ...
              <div className="flex items-center justify-center gap-3 mb-6">
                <div className="w-24 h-1 bg-gradient-to-r from-transparent to-primary-300 rounded-full"></div>
                <svg
                  className="w-6 h-6 text-primary-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path d="M10 3.5a1.5 1.5 0 013 0 1.5 1.5 0 01-3 0zM10 8.5a1.5 1.5 0 013 0 1.5 1.5 0 01-3 0zM10 13.5a1.5 1.5 0 013 0 1.5 1.5 0 01-3 0z" />
                </svg>
                <div className="w-24 h-1 bg-gradient-to-l from-transparent to-primary-300 rounded-full"></div>
              </div>
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                ...
                , carefully crafted to nourish your soil and boost crop yields
                naturally.
            ...
            <div className="text-center mt-14">
              <Link
                href="/products"
                className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-primary-600 via-primary-700 to-emerald-600 text-white px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary-500/30 hover:scale-105 overflow-hidden"
              >
                {/* Shimmer Effect */}
