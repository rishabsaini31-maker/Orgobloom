      ...
      <main className="smooth-scroll min-h-screen">
        ...
        <section className="relative py-12 md:py-20 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-10 right-10 w-40 h-40 bg-emerald-400 rounded-full blur-3xl opacity-20 animate-gentle-pulse" style={{ animationDelay: "1s" }}></div>
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <FadeInSection>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">
                    ...
                    <span className="bg-gradient-to-r from-primary-600 to-green-500 bg-clip-text text-transparent"> Healthier Crops</span>
                  </h1>
                </FadeInSection>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              ...
              <FadeInSection>
                <div className="group glass rounded-2xl p-6 shadow-lg hover:shadow-2xl border border-gray-100 text-center hover-lift">
                  ...
                  <p className="text-gray-600">No harmful chemicals, safe for your family, pets, and the environment.</p>
                </div>
              </FadeInSection>
              {/* Benefit 2 */}
              <FadeInSection>
                <div className="group glass rounded-2xl p-6 shadow-lg hover:shadow-2xl border border-gray-100 text-center hover-lift" style={{ transitionDelay: "100ms" }}>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Boosts Soil Health</h3>
                  <p className="text-gray-600">Improves soil structure, water retention, and nutrient availability.</p>
                </div>
              </FadeInSection>
              {/* Benefit 3 */}
              <FadeInSection>
                <div className="group glass rounded-2xl p-6 shadow-lg hover:shadow-2xl border border-gray-100 text-center hover-lift" style={{ transitionDelay: "200ms" }}>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Better Yields</h3>
                  <p className="text-gray-600">Healthier plants produce more nutritious and flavorful harvests.</p>
                </div>
              </FadeInSection>
              {/* Benefit 4 */}
              <FadeInSection>
                <div className="group glass rounded-2xl p-6 shadow-lg hover:shadow-2xl border border-gray-100 text-center hover-lift" style={{ transitionDelay: "300ms" }}>
                  ...
                  <p className="text-gray-600">Sustainable farming practices that protect our planet for future generations.</p>
                </div>
              </FadeInSection>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center text-white">
              <div className="group">
                ...
                <div className="text-primary-100 text-sm md:text-base">Happy Farmers</div>
              </div>
              <div className="group">
                <div className="text-3xl md:text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">
                  <AnimatedCounter end={100} suffix="%" />
                </div>
                <div className="text-primary-100 text-sm md:text-base">Organic Products</div>
              </div>
              <div className="group">
                <div className="text-3xl md:text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">
                  <AnimatedCounter end={50} suffix="+" />
                </div>
                <div className="text-primary-100 text-sm md:text-base">Cities Served</div>
              </div>
              <div className="group">
                <div className="text-3xl md:text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">4.9★</div>
                <div className="text-primary-100 text-sm md:text-base">Customer Rating</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12">
              <div className="flex items-center gap-2 text-gray-600 hover:text-primary-600 transition-colors">
                ...
                <span className="text-sm font-semibold">100% Organic Certified</span>
              </div>
              <div className="flex items-center gap-2 text-gray-600 hover:text-primary-600 transition-colors">
