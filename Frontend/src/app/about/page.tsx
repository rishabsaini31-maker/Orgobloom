      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              We envision a world where organic, sustainable, and
              health-conscious living is the norm, not the exception. Through
              Orgobloom, we're building a community of conscious consumers who
              care about their health, their families, and our planet.
            </p>
            <p className="text-gray-600 leading-relaxed">
              By supporting local farmers, reducing carbon footprints, and
              promoting biodiversity, we're committed to creating a better
          ...
          <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-lg p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              believed that organic living should be accessible to everyone.
              What started as a small farmers market stand has grown into a
              thriving e-commerce platform serving thousands of customers across
              the country.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Today, we work with over 500 certified organic farmers and
              producers to bring you the finest selection of organic products.
              Our commitment to quality and sustainability remains as strong as
              ever.
            </p>
            <p className="text-gray-600 leading-relaxed">
