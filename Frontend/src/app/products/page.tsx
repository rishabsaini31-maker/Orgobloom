...
export default function ProductsPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-primary-600 to-green-600 text-white py-20 overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 drop-shadow-lg animate-fade-in-up">
            Our Premium Products
          </h1>
          <p className="text-xl md:text-2xl opacity-90 max-w-2xl mx-auto mb-6 animate-fade-in-up delay-100">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8 animate-fade-in-up delay-200">
            <span className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-6 py-3 text-lg font-semibold shadow-lg backdrop-blur-md">
              <span className="text-2xl">🌱</span> 100% Organic
            </span>
            <span className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-6 py-3 text-lg font-semibold shadow-lg backdrop-blur-md">
              <span className="text-2xl">🥕</span> Maximum Yields
            </span>
            <span className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-6 py-3 text-lg font-semibold shadow-lg backdrop-blur-md">
              <span className="text-2xl">♻️</span> Eco-Friendly
            </span>
          </div>
        </div>
        {/* Decorative shapes */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
          <svg
            className="absolute top-0 left-0 w-1/2 h-40 opacity-20"
            viewBox="0 0 400 100"
            fill="none"
          >
            <ellipse cx="200" cy="50" rx="200" ry="50" fill="#fff" />
          </svg>
          <svg
            className="absolute bottom-0 right-0 w-1/3 h-32 opacity-10"
            viewBox="0 0 300 80"
            fill="none"
          >
            <ellipse cx="150" cy="40" rx="150" ry="40" fill="#fff" />
          </svg>
        </div>
      </section>
