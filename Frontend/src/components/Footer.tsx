        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <h3 className="text-xl font-bold">Orgobloom</h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Premium organic fertilizers for sustainable farming and healthier
              plants. We believe in nurturing nature for a greener tomorrow.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>orgobloom5033@gmail.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 flex-shrink-0"
        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm text-center sm:text-left">
              © 2026 Orgobloom. All rights reserved.
            </p>
